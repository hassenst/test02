 ...
 */ function validateAge(age) {
    ...
    if (calculateAge(dateField.value) < age) dateField.setCustomValidity("You must be at least 18 years old.");
 ...
 */ function validatePasswords(passwordID, compareID) {
    ...
    if (pwA.value !== pwB.value) pwA.setCustomValidity("Passwords do not match.");
    else pwA.setCustomValidity("");
    pwA.reportValidity();
}
/**
 * CharsLeft
...
form.addEventListener("submit", (event)=>{
    ...
    Object.entries(form).forEach((entry)=>{
        ...
        if (!input.willValidate || input.hasAttribute("formnovalidate")) return;
        ...
        if (!input.checkValidity()) {
            ...
            if (input.validity.tooShort) errorMessage = `Your ${input.name} must contain at least ${input.minLength} chars`;
        } else {
            //set the icons
...
},{}]},["hklly","bNKaB"], "bNKaB", "parcelRequire589a")
